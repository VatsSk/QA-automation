...
public class SeleniumExecutor {
    ...
    public SeleniumExecutor(org.springframework.core.env.Environment env, ScreenshotService screenshotService, LLMServices lLMServices, AIScreenshotService aiScreenshotService) {
