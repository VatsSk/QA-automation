        ...
        String script = """
                        return (function(){
                          ...
                          function visibilityOk(el){
                            ...
                            const insideHideParent =
                                el.closest('.hide, .hidden, .d-none, .ng-hide') !== null;
                        
                            return visible || insideHideParent;
                          }
                          ...
                          return Array.from(document.querySelectorAll(selector))
                            .filter(el => el.id && visibilityOk(el))
                            .map(function(el){
